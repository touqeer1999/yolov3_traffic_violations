...
def run_program():
    ...
    os.chdir(os.path.join(os.path.dirname(__file__),'C:\\Users\\shariff\\Downloads\\yolov3_traffic_violations-master\\yolov3_traffic_violations-master\\keras-yolo3'))
    os.system('python yolo_video.py --score 0.7 --input demo_input786.mp4 --output demo_output786.mp4')
...
def generate_challans():
    ...
    for f in os.listdir('C:\\Users\\shariff\\Downloads\\yolov3_traffic_violations-master\\yolov3_traffic_violations-master\\yolov3_Helmet_Detection\\violations'):
        lplate = f.split('.')[0]
        conn = sqlite3.connect('../vehicles.db')
        cursor = conn.cursor()
        ...
        canvas = canvas1.Canvas(os.path.join('C:\\Users\\shariff\\Downloads\\yolov3_traffic_violations-master\\yolov3_traffic_violations-master\\keras-yolo3\\challans',lplate+".pdf"), pagesize=letter)
        ...
        canvas.drawString(300,450,'Rs. 1000')

        canvas.drawImage(os.path.join('C:\\Users\\shariff\\Downloads\\yolov3_traffic_violations-master\\yolov3_traffic_violations-master\\yolov3_Helmet_Detection\\violations',f), 30,150,250,250,preserveAspectRatio=True, mask='auto')


        canvas.save()
    
    labelr = Label(master,  
              text ="All challans generated, stored in folder"+ str(os.path.join(os.path.dirname(__file__),'C:\\Users\\shariff\\Downloads\\yolov3_traffic_violations-master\\yolov3_traffic_violations-master\\keras-yolo3','C:\\Users\\shariff\\Downloads\\yolov3_traffic_violations-master\\yolov3_traffic_violations-master\\keras-yolo3\\challans')))
